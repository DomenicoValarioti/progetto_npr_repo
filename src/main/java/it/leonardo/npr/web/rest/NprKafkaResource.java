...
@RestController
@RequestMapping("/api/npr-kafka")
public class NprKafkaResource {
    private final Logger log = LoggerFactory.getLogger(NprKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NprKafkaResource(KafkaProperties kafkaProperties) {
