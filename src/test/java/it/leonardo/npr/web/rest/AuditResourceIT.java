package it.leonardo.npr.web.rest;
...
import it.leonardo.npr.NprApp;
import it.leonardo.npr.config.TestSecurityConfiguration;
import it.leonardo.npr.config.audit.AuditEventConverter;
import it.leonardo.npr.domain.PersistentAuditEvent;
import it.leonardo.npr.repository.PersistenceAuditEventRepository;
import it.leonardo.npr.security.AuthoritiesConstants;
import it.leonardo.npr.service.AuditEventService;
...
@SpringBootTest(classes = { NprApp.class, TestSecurityConfiguration.class })
@Transactional
